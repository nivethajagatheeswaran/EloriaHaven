...
const T = {
  English: {
    ...
    // English — add inside T.English
    homeMoodLabel: "Today's mood",
    checkinSavedMsg: "✓ Check-in saved · Your Haven Tree is growing 🌱",
    yourHavenTree: "Your Haven Tree",
    dayLabel: "Day",
    leavesGrowing: "leaves growing",
    seeFullTree: "See full tree →",
    whatWouldYouLikeShort: "What would you like?",
    relaxLabel: "Relax", relaxSub: "Breathing, music, kolam",
    focusLabel: "Focus", focusSub: "Tasks, grades, timer",
    journalLabel: "Journal", journalSub: "Write or speak freely",
    talkLabel: "Talk to Eloria", talkSub: "I'm here to listen",
    moodVeryLow: "Very Low", moodLow: "Low", moodNeutral: "Neutral", moodGood: "Good", moodGreat: "Great",
    // English
    kolamTitle: "Kolam Therapy",
    kolamSubtitle: "Focus on the pattern. Let your mind settle.",
    choosePattern: "Choose a pattern",
    traceGlowing: "Trace the glowing pattern above",
    startTracing: "Start tracing",
    drawOverPattern: "Draw over the pattern with your finger",
    clearBtn: "Clear", doneBtn: "Done ✓",
    beautifulTitle: "Beautiful!",
    completedKolam: "You completed the kolam",
    flowersBloomed: "🌳 Flowers bloomed on your Haven Tree",
    backToRelaxBtn: "Back to Relax", tryAgainBtn: "Try again",
    patternSimple: "Simple", patternFlower: "Flower", patternStar: "Star",
    patternChain: "Chain", patternLotus: "Lotus", patternPeacock: "Peacock",
    dotsLabel: "Dots",
    // English
    storiesTitle: "Stories",
    storiesSubtitle: "Let Eloria tell you something calm before you sleep.",
    storiesOwnTheme: "Or describe your own theme",
    storiesCustomPlaceholder: "e.g. a lighthouse in winter",
    storiesTellIt: "Tell it",
    storiesThinking: "Eloria is thinking of a story…",
    storiesReadAloud: "🔊 Read aloud",
    storiesResume: "▶ Resume", storiesPause: "⏸ Pause", storiesStop: "⏹ Stop",
    storiesAnother: "← Another story",
    storiesErrorGeneric: "Something went wrong",
    storiesErrorFallback: "Eloria could not write a story right now",
    storiesNoVoiceWarning: "No {lang} voice is installed on this device, so this will read in English instead.",
    relaxNavBtn: "Relax",
    themeForest: "A quiet forest", themeRain: "Rain on a rooftop", themeOcean: "A calm shore",
    themeVillage: "An old village at night", themeTrain: "A slow train journey", themeGarden: "A garden at dusk",
  ...
  Tamil: {
    ...
    selectLanguage: "மொழி",
    // Tamil — add inside T.Tamil
    homeMoodLabel: "இன்றைய மனநிலை",
    checkinSavedMsg: "✓ பதிவு சேமிக்கப்பட்டது · உங்கள் ஹேவன் மரம் வளர்கிறது 🌱",
    yourHavenTree: "உங்கள் ஹேவன் மரம்",
    dayLabel: "நாள்",
    leavesGrowing: "இலைகள் வளர்கின்றன",
    seeFullTree: "முழு மரத்தைப் பார் →",
    whatWouldYouLikeShort: "என்ன செய்ய விரும்புகிறீர்கள்?",
    relaxLabel: "ரிலாக்ஸ்", relaxSub: "மூச்சு, இசை, கோலம்",
    focusLabel: "ஃபோகஸ்", focusSub: "பணிகள், மதிப்பெண்கள், டைமர்",
    journalLabel: "நாட்குறிப்பு", journalSub: "சுதந்திரமாக எழுது அல்லது பேசு",
    talkLabel: "Eloria உடன் பேசு", talkSub: "நான் கேட்கிறேன்",
    moodVeryLow: "மிகவும் குறைவு", moodLow: "குறைவு", moodNeutral: "நடுநிலை", moodGood: "நல்லது", moodGreat: "சிறப்பு",
    // Tamil
    kolamTitle: "கோலம் சிகிச்சை",
    kolamSubtitle: "வடிவத்தில் கவனம் செலுத்துங்கள். மனதை அமைதிப்படுத்துங்கள்.",
    choosePattern: "ஒரு வடிவத்தைத் தேர்வுசெய்",
    traceGlowing: "மேலே உள்ள பிரகாசிக்கும் வடிவத்தை வரையவும்",
    startTracing: "வரையத் தொடங்கு",
    drawOverPattern: "உங்கள் விரலால் வடிவத்தின் மேல் வரையவும்",
    clearBtn: "அழி", doneBtn: "முடிந்தது ✓",
    beautifulTitle: "அழகாக இருக்கிறது!",
    completedKolam: "நீங்கள் கோலத்தை முடித்தீர்கள்",
    flowersBloomed: "🌳 உங்கள் ஹேவன் மரத்தில் பூக்கள் மலர்ந்தன",
    backToRelaxBtn: "ரிலாக்ஸுக்குத் திரும்பு", tryAgainBtn: "மீண்டும் முயற்சி செய்",
    patternSimple: "எளிமையானது", patternFlower: "மலர்", patternStar: "நட்சத்திரம்",
    patternChain: "சங்கிலி", patternLotus: "தாமரை", patternPeacock: "மயில்",
    dotsLabel: "புள்ளிகள்",
    // Tamil
    storiesTitle: "கதைகள்",
    storiesSubtitle: "நீங்கள் தூங்குவதற்கு முன் Eloria ஒரு அமைதியான கதை சொல்லட்டும்.",
    storiesOwnTheme: "அல்லது உங்கள் சொந்த கருப்பொருளை விவரிக்கவும்",
    storiesCustomPlaceholder: "எ.கா. குளிர்காலத்தில் ஒரு கலங்கரை விளக்கம்",
    storiesTellIt: "சொல்லு",
    storiesThinking: "Eloria ஒரு கதையை யோசிக்கிறது…",
    storiesReadAloud: "🔊 சத்தமாக படி",
    storiesResume: "▶ தொடரவும்", storiesPause: "⏸ இடைநிறுத்து", storiesStop: "⏹ நிறுத்து",
    storiesAnother: "← மற்றொரு கதை",
    storiesErrorGeneric: "ஏதோ தவறு நடந்தது",
    storiesErrorFallback: "Eloria இப்போது கதை எழுத முடியவில்லை",
    storiesNoVoiceWarning: "இந்த சாதனத்தில் {lang} குரல் நிறுவப்படவில்லை, எனவே இது ஆங்கிலத்தில் படிக்கப்படும்.",
    relaxNavBtn: "ரிலாக்ஸ்",
    themeForest: "அமைதியான காடு", themeRain: "கூரையில் மழை", themeOcean: "அமைதியான கடற்கரை",
    themeVillage: "இரவில் ஒரு பழைய கிராமம்", themeTrain: "மெதுவான ரயில் பயணம்", themeGarden: "மாலையில் ஒரு தோட்டம்",
  ...
  Telugu: {
    ...
    selectLanguage: "భాష",
    // Telugu — add inside T.Telugu
    homeMoodLabel: "ఈరోజు మూడ్",
    checkinSavedMsg: "✓ చెక్-ఇన్ సేవ్ అయింది · మీ హేవెన్ చెట్టు పెరుగుతోంది 🌱",
    yourHavenTree: "మీ హేవెన్ చెట్టు",
    dayLabel: "రోజు",
    leavesGrowing: "ఆకులు పెరుగుతున్నాయి",
    seeFullTree: "పూర్తి చెట్టు చూడండి →",
    whatWouldYouLikeShort: "మీరు ఏమి చేయాలనుకుంటున్నారు?",
    relaxLabel: "రిలాక్స్", relaxSub: "శ్వాస, సంగీతం, కోలం",
    focusLabel: "ఫోకస్", focusSub: "పనులు, గ్రేడ్‌లు, టైమర్",
    journalLabel: "జర్నల్", journalSub: "స్వేచ్ఛగా రాయండి లేదా మాట్లాడండి",
    talkLabel: "Eloria తో మాట్లాడు", talkSub: "నేను వింటున్నాను",
    moodVeryLow: "చాలా తక్కువ", moodLow: "తక్కువ", moodNeutral: "సాధారణ", moodGood: "మంచిది", moodGreat: "అద్భుతం",
    // Telugu
    kolamTitle: "కోలం థెరపీ",
    kolamSubtitle: "నమూనాపై దృష్టి పెట్టండి. మీ మనసును స్థిరపరచుకోండి.",
    choosePattern: "ఒక నమూనాను ఎంచుకోండి",
    traceGlowing: "పైన ఉన్న మెరుస్తున్న నమూనాను గీయండి",
    startTracing: "గీయడం ప్రారంభించు",
    drawOverPattern: "మీ వేలితో నమూనాపై గీయండి",
    clearBtn: "క్లియర్", doneBtn: "పూర్తయింది ✓",
    beautifulTitle: "అందంగా ఉంది!",
    completedKolam: "మీరు కోలం పూర్తి చేశారు",
    flowersBloomed: "🌳 మీ హేవెన్ చెట్టుపై పువ్వులు విరిశాయి",
    backToRelaxBtn: "రిలాక్స్‌కు వెళ్ళు", tryAgainBtn: "మళ్ళీ ప్రయత్నించు",
    patternSimple: "సాధారణ", patternFlower: "పువ్వు", patternStar: "నక్షత్రం",
    patternChain: "గొలుసు", patternLotus: "తామర", patternPeacock: "నెమలి",
    dotsLabel: "చుక్కలు",
    // Telugu
    storiesTitle: "కథలు",
    storiesSubtitle: "మీరు నిద్రపోయే ముందు Eloria ప్రశాంతమైన కథ చెప్పనివ్వండి.",
    storiesOwnTheme: "లేదా మీ సొంత థీమ్‌ను వివరించండి",
    storiesCustomPlaceholder: "ఉదా. చలికాలంలో ఒక లైట్‌హౌస్",
    storiesTellIt: "చెప్పు",
    storiesThinking: "Eloria ఒక కథ గురించి ఆలోచిస్తోంది…",
    storiesReadAloud: "🔊 బిగ్గరగా చదువు",
    storiesResume: "▶ కొనసాగించు", storiesPause: "⏸ పాజ్", storiesStop: "⏹ ఆపు",
    storiesAnother: "← మరొక కథ",
    storiesErrorGeneric: "ఏదో తప్పు జరిగింది",
    storiesErrorFallback: "Eloria ఇప్పుడు కథ రాయలేకపోయింది",
    storiesNoVoiceWarning: "ఈ పరికరంలో {lang} వాయిస్ ఇన్‌స్టాల్ చేయబడలేదు, కాబట్టి ఇది ఇంగ్లీష్‌లో చదవబడుతుంది.",
    relaxNavBtn: "రిలాక్స్",
    themeForest: "ప్రశాంతమైన అడవి", themeRain: "పైకప్పుపై వర్షం", themeOcean: "ప్రశాంతమైన తీరం",
    themeVillage: "రాత్రి పాత గ్రామం", themeTrain: "నెమ్మదైన రైలు ప్రయాణం", themeGarden: "సాయంత్రం తోట",
  ...
  Malayalam: {
    ...
    selectLanguage: "ഭാഷ",
    // Malayalam — add inside T.Malayalam
    homeMoodLabel: "ഇന്നത്തെ മൂഡ്",
    checkinSavedMsg: "✓ ചെക്ക്-ഇൻ സേവ് ആയി · നിങ്ങളുടെ ഹേവൻ മരം വളരുന്നു 🌱",
    yourHavenTree: "നിങ്ങളുടെ ഹേവൻ മരം",
    dayLabel: "ദിവസം",
    leavesGrowing: "ഇലകൾ വളരുന്നു",
    seeFullTree: "മുഴുവൻ മരം കാണൂ →",
    whatWouldYouLikeShort: "നിങ്ങൾ എന്ത് ചെയ്യാൻ ആഗ്രഹിക്കുന്നു?",
    relaxLabel: "റിലാക്സ്", relaxSub: "ശ്വാസം, സംഗീതം, കോലം",
    focusLabel: "ഫോക്കസ്", focusSub: "ജോലികൾ, ഗ്രേഡുകൾ, ടൈമർ",
    journalLabel: "ജേർണൽ", journalSub: "സ്വതന്ത്രമായി എഴുതൂ അല്ലെങ്കിൽ സംസാരിക്കൂ",
    talkLabel: "Eloria-മായി സംസാരിക്കൂ", talkSub: "ഞാൻ കേൾക്കുന്നു",
    moodVeryLow: "വളരെ കുറവ്", moodLow: "കുറവ്", moodNeutral: "സാധാരണ", moodGood: "നല്ലത്", moodGreat: "മികച്ചത്",
    // Malayalam
    kolamTitle: "കോലം തെറാപ്പി",
    kolamSubtitle: "പാറ്റേണിൽ ശ്രദ്ധ കേന്ദ്രീകരിക്കൂ. മനസ്സിനെ ശാന്തമാക്കൂ.",
    choosePattern: "ഒരു പാറ്റേൺ തിരഞ്ഞെടുക്കൂ",
    traceGlowing: "മുകളിലുള്ള തിളങ്ങുന്ന പാറ്റേൺ വരയ്ക്കൂ",
    startTracing: "വരയ്ക്കൽ ആരംഭിക്കൂ",
    drawOverPattern: "നിങ്ങളുടെ വിരൽ കൊണ്ട് പാറ്റേണിന് മുകളിൽ വരയ്ക്കൂ",
    clearBtn: "മായ്ക്കൂ", doneBtn: "പൂർത്തിയായി ✓",
    beautifulTitle: "മനോഹരം!",
    completedKolam: "നിങ്ങൾ കോലം പൂർത്തിയാക്കി",
    flowersBloomed: "🌳 നിങ്ങളുടെ ഹേവൻ മരത്തിൽ പൂക്കൾ വിരിഞ്ഞു",
    backToRelaxBtn: "റിലാക്സിലേക്ക് മടങ്ങൂ", tryAgainBtn: "വീണ്ടും ശ്രമിക്കൂ",
    patternSimple: "ലളിതം", patternFlower: "പൂവ്", patternStar: "നക്ഷത്രം",
    patternChain: "ചെയിൻ", patternLotus: "താമര", patternPeacock: "മയിൽ",
    dotsLabel: "പൊട്ടുകൾ",
    // Malayalam
    storiesTitle: "കഥകൾ",
    storiesSubtitle: "നിങ്ങൾ ഉറങ്ങുന്നതിന് മുമ്പ് Eloria ശാന്തമായ ഒരു കഥ പറയട്ടെ.",
    storiesOwnTheme: "അല്ലെങ്കിൽ നിങ്ങളുടെ സ്വന്തം തീം വിവരിക്കൂ",
    storiesCustomPlaceholder: "ഉദാ. ശൈത്യകാലത്തെ ഒരു ലൈറ്റ്ഹൗസ്",
    storiesTellIt: "പറയൂ",
    storiesThinking: "Eloria ഒരു കഥയെക്കുറിച്ച് ചിന്തിക്കുന്നു…",
    storiesReadAloud: "🔊 ഉറക്കെ വായിക്കൂ",
    storiesResume: "▶ തുടരുക", storiesPause: "⏸ താൽക്കാലികമായി നിർത്തുക", storiesStop: "⏹ നിർത്തുക",
    storiesAnother: "← മറ്റൊരു കഥ",
    storiesErrorGeneric: "എന്തോ കുഴപ്പം സംഭവിച്ചു",
    storiesErrorFallback: "Eloria-ക്ക് ഇപ്പോൾ ഒരു കഥ എഴുതാൻ കഴിഞ്ഞില്ല",
    storiesNoVoiceWarning: "ഈ ഉപകരണത്തിൽ {lang} വോയ്സ് ഇൻസ്റ്റാൾ ചെയ്തിട്ടില്ല, അതിനാൽ ഇത് ഇംഗ്ലീഷിൽ വായിക്കും.",
    relaxNavBtn: "റിലാക്സ്",
    themeForest: "ശാന്തമായ കാട്", themeRain: "മേൽക്കൂരയിൽ മഴ", themeOcean: "ശാന്തമായ കടൽത്തീരം",
    themeVillage: "രാത്രിയിലെ പഴയ ഗ്രാമം", themeTrain: "സാവധാനത്തിലുള്ള ട്രെയിൻ യാത്ര", themeGarden: "സന്ധ്യയിലെ ഒരു തോട്ടം",
  ...
  Kannada: {
    ...
    selectLanguage: "ಭಾಷೆ",
    // Kannada — add inside T.Kannada
    homeMoodLabel: "ಇಂದಿನ ಮನಸ್ಥಿತಿ",
    checkinSavedMsg: "✓ ಚೆಕ್-ಇನ್ ಉಳಿಸಲಾಗಿದೆ · ನಿಮ್ಮ ಹೇವನ್ ಮರ ಬೆಳೆಯುತ್ತಿದೆ 🌱",
    yourHavenTree: "ನಿಮ್ಮ ಹೇವನ್ ಮರ",
    dayLabel: "ದಿನ",
    leavesGrowing: "ಎಲೆಗಳು ಬೆಳೆಯುತ್ತಿವೆ",
    seeFullTree: "ಪೂರ್ಣ ಮರ ನೋಡಿ →",
    whatWouldYouLikeShort: "ನೀವು ಏನು ಮಾಡಲು ಬಯಸುತ್ತೀರಿ?",
    relaxLabel: "ರಿಲ್ಯಾಕ್ಸ್", relaxSub: "ಉಸಿರು, ಸಂಗೀತ, ಕೋಲಂ",
    focusLabel: "ಫೋಕಸ್", focusSub: "ಕಾರ್ಯಗಳು, ಗ್ರೇಡ್‌ಗಳು, ಟೈಮರ್",
    journalLabel: "ಜರ್ನಲ್", journalSub: "ಸ್ವತಂತ್ರವಾಗಿ ಬರೆಯಿರಿ ಅಥವಾ ಮಾತನಾಡಿ",
    talkLabel: "Eloria ನೊಂದಿಗೆ ಮಾತನಾಡಿ", talkSub: "ನಾನು ಕೇಳುತ್ತೇನೆ",
    moodVeryLow: "ಅತಿ ಕಡಿಮೆ", moodLow: "ಕಡಿಮೆ", moodNeutral: "ಸಾಮಾನ್ಯ", moodGood: "ಚೆನ್ನಾಗಿದೆ", moodGreat: "ಅತ್ಯುತ್ತಮ",
    // Kannada
    kolamTitle: "ಕೋಲಂ ಥೆರಪಿ",
    kolamSubtitle: "ಮಾದರಿಯ ಮೇಲೆ ಗಮನ ಕೇಂದ್ರೀಕರಿಸಿ. ಮನಸ್ಸನ್ನು ಶಾಂತಗೊಳಿಸಿ.",
    choosePattern: "ಒಂದು ಮಾದರಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ",
    traceGlowing: "ಮೇಲಿನ ಹೊಳೆಯುವ ಮಾದರಿಯನ್ನು ಗೀಚಿ",
    startTracing: "ಗೀಚಲು ಪ್ರಾರಂಭಿಸಿ",
    drawOverPattern: "ನಿಮ್ಮ ಬೆರಳಿನಿಂದ ಮಾದರಿಯ ಮೇಲೆ ಗೀಚಿ",
    clearBtn: "ಅಳಿಸಿ", doneBtn: "ಮುಗಿದಿದೆ ✓",
    beautifulTitle: "ಸುಂದರವಾಗಿದೆ!",
    completedKolam: "ನೀವು ಕೋಲಂ ಪೂರ್ಣಗೊಳಿಸಿದ್ದೀರಿ",
    flowersBloomed: "🌳 ನಿಮ್ಮ ಹೇವನ್ ಮರದಲ್ಲಿ ಹೂವುಗಳು ಅರಳಿದವು",
    backToRelaxBtn: "ರಿಲ್ಯಾಕ್ಸ್‌ಗೆ ಹಿಂತಿರುಗಿ", tryAgainBtn: "ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ",
    patternSimple: "ಸರಳ", patternFlower: "ಹೂವು", patternStar: "ನಕ್ಷತ್ರ",
    patternChain: "ಸರಪಳಿ", patternLotus: "ಕಮಲ", patternPeacock: "ನವಿಲು",
    dotsLabel: "ಚುಕ್ಕೆಗಳು",
    // Kannada
    storiesTitle: "ಕಥೆಗಳು",
    storiesSubtitle: "ನೀವು ನಿದ್ರಿಸುವ ಮೊದಲು Eloria ಶಾಂತವಾದ ಕಥೆಯನ್ನು ಹೇಳಲಿ.",
    storiesOwnTheme: "ಅಥವಾ ನಿಮ್ಮ ಸ್ವಂತ ಥೀಮ್ ವಿವರಿಸಿ",
    storiesCustomPlaceholder: "ಉದಾ. ಚಳಿಗಾಲದಲ್ಲಿ ಒಂದು ಲೈಟ್‌ಹೌಸ್",
    storiesTellIt: "ಹೇಳು",
    storiesThinking: "Eloria ಒಂದು ಕಥೆಯ ಬಗ್ಗೆ ಯೋಚಿಸುತ್ತಿದೆ…",
    storiesReadAloud: "🔊 ಗಟ್ಟಿಯಾಗಿ ಓದು",
    storiesResume: "▶ ಮುಂದುವರಿಸಿ", storiesPause: "⏸ ವಿರಾಮ", storiesStop: "⏹ ನಿಲ್ಲಿಸು",
    storiesAnother: "← ಇನ್ನೊಂದು ಕಥೆ",
    storiesErrorGeneric: "ಏನೋ ತಪ್ಪಾಗಿದೆ",
    storiesErrorFallback: "Eloria ಈಗ ಕಥೆ ಬರೆಯಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ",
    storiesNoVoiceWarning: "ಈ ಸಾಧನದಲ್ಲಿ {lang} ಧ್ವನಿ ಸ್ಥಾಪಿಸಲಾಗಿಲ್ಲ, ಆದ್ದರಿಂದ ಇದು ಇಂಗ್ಲಿಷ್‌ನಲ್ಲಿ ಓದಲಾಗುತ್ತದೆ.",
    relaxNavBtn: "ರಿಲ್ಯಾಕ್ಸ್",
    themeForest: "ಶಾಂತ ಕಾಡು", themeRain: "ಮೇಲ್ಛಾವಣಿಯ ಮೇಲೆ ಮಳೆ", themeOcean: "ಶಾಂತ ತೀರ",
    themeVillage: "ರಾತ್ರಿಯ ಹಳೆಯ ಹಳ್ಳಿ", themeTrain: "ನಿಧಾನ ರೈಲು ಪ್ರಯಾಣ", themeGarden: "ಸಂಜೆಯ ಒಂದು ಉದ್ಯಾನ",
  ...
  Hindi: {
    ...
    selectLanguage: "भाषा",
    // Hindi — add inside T.Hindi
    homeMoodLabel: "आज का मूड",
    checkinSavedMsg: "✓ चेक-इन सहेजा गया · आपका हेवन ट्री बढ़ रहा है 🌱",
    yourHavenTree: "आपका हेवन ट्री",
    dayLabel: "दिन",
    leavesGrowing: "पत्तियाँ बढ़ रही हैं",
    seeFullTree: "पूरा पेड़ देखें →",
    whatWouldYouLikeShort: "आप क्या करना चाहेंगे?",
    relaxLabel: "रिलैक्स", relaxSub: "सांस, संगीत, कोलम",
    focusLabel: "फोकस", focusSub: "कार्य, ग्रेड, टाइमर",
    journalLabel: "जर्नल", journalSub: "स्वतंत्र रूप से लिखें या बोलें",
    talkLabel: "Eloria से बात करें", talkSub: "मैं सुन रहा हूं",
    moodVeryLow: "बहुत कम", moodLow: "कम", moodNeutral: "सामान्य", moodGood: "अच्छा", moodGreat: "बहुत अच्छा",
    // Hindi
    kolamTitle: "कोलम थेरेपी",
    kolamSubtitle: "पैटर्न पर ध्यान दें। अपने मन को शांत होने दें।",
    choosePattern: "एक पैटर्न चुनें",
    traceGlowing: "ऊपर दिए चमकते पैटर्न को खींचें",
    startTracing: "बनाना शुरू करें",
    drawOverPattern: "अपनी उंगली से पैटर्न के ऊपर बनाएं",
    clearBtn: "साफ करें", doneBtn: "पूर्ण ✓",
    beautifulTitle: "सुंदर!",
    completedKolam: "आपने कोलम पूरा किया",
    flowersBloomed: "🌳 आपके हेवन ट्री पर फूल खिले",
    backToRelaxBtn: "रिलैक्स पर वापस जाएं", tryAgainBtn: "फिर से कोशिश करें",
    patternSimple: "सरल", patternFlower: "फूल", patternStar: "तारा",
    patternChain: "श्रृंखला", patternLotus: "कमल", patternPeacock: "मोर",
    dotsLabel: "बिंदु",
    // Hindi
    storiesTitle: "कहानियाँ",
    storiesSubtitle: "सोने से पहले Eloria आपको एक शांत कहानी सुनाए।",
    storiesOwnTheme: "या अपनी खुद की थीम बताएं",
    storiesCustomPlaceholder: "उदा. सर्दियों में एक लाइटहाउस",
    storiesTellIt: "बताओ",
    storiesThinking: "Eloria एक कहानी के बारे में सोच रहा है…",
    storiesReadAloud: "🔊 ज़ोर से पढ़ें",
    storiesResume: "▶ जारी रखें", storiesPause: "⏸ रोकें", storiesStop: "⏹ बंद करें",
    storiesAnother: "← एक और कहानी",
    storiesErrorGeneric: "कुछ गलत हो गया",
    storiesErrorFallback: "Eloria अभी कहानी नहीं लिख पाया",
    storiesNoVoiceWarning: "इस डिवाइस पर {lang} आवाज़ इंस्टॉल नहीं है, इसलिए यह अंग्रेज़ी में पढ़ी जाएगी।",
    relaxNavBtn: "रिलैक्स",
    themeForest: "एक शांत जंगल", themeRain: "छत पर बारिश", themeOcean: "एक शांत तट",
    themeVillage: "रात में एक पुराना गाँव", themeTrain: "एक धीमी ट्रेन यात्रा", themeGarden: "शाम का एक बगीचा",
...
export default function App() {
  ...
  return (
    <div style={{ background: page === "home" ? "transparent" : bodyBg, minHeight: "100vh", transition: "background 0.8s ease", position: "relative" }}>
      ...
      {page === "kolam" && <KolamPage onNavigate={navigate} dark={dark} t={t} />}
