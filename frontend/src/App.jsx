...
const T = {
  English: {
    ...
    orDescribeTheme: "Or describe your own theme",
    customThemePlaceholder: "e.g. a lighthouse in winter",
    tellIt: "Tell it",
    eloriaThinking: "Eloria is thinking of a story…",
    readAloud: "🔊 Read aloud", pauseBtn: "⏸ Pause", resumeBtn: "▶ Resume", stopBtn: "⏹ Stop",
  ...
  Tamil: {
    ...
    // Tamil
    storiesTitle: "கதைகள்",
    storiesSubtitle: "நீங்கள் தூங்குவதற்கு முன் Eloria அமைதியான ஒன்றைச் சொல்லட்டும்.",
    themeForest: "அமைதியான காடு", themeRain: "கூரையில் மழை", themeOcean: "அமைதியான கடற்கரை",
    themeVillage: "இரவில் பழைய கிராமம்", themeTrain: "மெதுவான ரயில் பயணம்", themeGarden: "மாலையில் தோட்டம்",
    orDescribeTheme: "அல்லது உங்கள் சொந்த கருப்பொருளை விவரிக்கவும்",
    customThemePlaceholder: "எ.கா. குளிர்காலத்தில் ஒரு கலங்கரை விளக்கம்",
    tellIt: "சொல்லு",
    eloriaThinking: "Eloria ஒரு கதையைப் பற்றி யோசிக்கிறது…",
  ...
  Telugu: {
    ...
    // Telugu
    storiesTitle: "కథలు",
    storiesSubtitle: "మీరు నిద్రపోయే ముందు Eloria ప్రశాంతమైనది చెప్పనివ్వండి.",
    themeForest: "నిశ్శబ్ద అడవి", themeRain: "పైకప్పుపై వర్షం", themeOcean: "ప్రశాంతమైన తీరం",
    themeVillage: "రాత్రిపూట పాత గ్రామం", themeTrain: "నెమ్మదైన రైలు ప్రయాణం", themeGarden: "సాయంత్రం తోట",
    orDescribeTheme: "లేదా మీ స్వంత థీమ్‌ను వివరించండి",
    customThemePlaceholder: "ఉదా. చలికాలంలో ఒక లైట్‌హౌస్",
    tellIt: "చెప్పు",
    eloriaThinking: "Eloria ఒక కథ గురించి ఆలోచిస్తోంది…",
  ...
  Malayalam: {
    ...
    // Malayalam
    storiesTitle: "കഥകൾ",
    storiesSubtitle: "നിങ്ങൾ ഉറങ്ങുന്നതിന് മുമ്പ് Eloria ശാന്തമായ എന്തെങ്കിലും പറയട്ടെ.",
    themeForest: "ശാന്തമായ വനം", themeRain: "മേൽക്കൂരയിൽ മഴ", themeOcean: "ശാന്തമായ തീരം",
    themeVillage: "രാത്രിയിലെ പഴയ ഗ്രാമം", themeTrain: "മന്ദഗതിയിലുള്ള ട്രെയിൻ യാത്ര", themeGarden: "സന്ധ്യയിലെ പൂന്തോട്ടം",
    orDescribeTheme: "അല്ലെങ്കിൽ നിങ്ങളുടെ സ്വന്തം തീം വിവരിക്കൂ",
    customThemePlaceholder: "ഉദാ. ശൈത്യകാലത്ത് ഒരു വിളക്കുമാടം",
    tellIt: "പറയൂ",
    eloriaThinking: "Eloria ഒരു കഥയെക്കുറിച്ച് ചിന്തിക്കുന്നു…",
  ...
  Kannada: {
    ...
    // Kannada
    storiesTitle: "ಕಥೆಗಳು",
    storiesSubtitle: "ನೀವು ನಿದ್ರಿಸುವ ಮೊದಲು Eloria ಶಾಂತವಾದ ಏನನ್ನಾದರೂ ಹೇಳಲಿ.",
    themeForest: "ಶಾಂತ ಕಾಡು", themeRain: "ಮೇಲ್ಛಾವಣಿಯ ಮೇಲೆ ಮಳೆ", themeOcean: "ಶಾಂತ ತೀರ",
    themeVillage: "ರಾತ್ರಿಯ ಹಳೆಯ ಹಳ್ಳಿ", themeTrain: "ನಿಧಾನ ರೈಲು ಪ್ರಯಾಣ", themeGarden: "ಸಂಜೆಯ ತೋಟ",
    orDescribeTheme: "ಅಥವಾ ನಿಮ್ಮ ಸ್ವಂತ ಥೀಮ್ ವಿವರಿಸಿ",
    customThemePlaceholder: "ಉದಾ. ಚಳಿಗಾಲದಲ್ಲಿ ಒಂದು ಲೈಟ್‌ಹೌಸ್",
    tellIt: "ಹೇಳು",
    eloriaThinking: "Eloria ಒಂದು ಕಥೆಯ ಬಗ್ಗೆ ಯೋಚಿಸುತ್ತಿದೆ…",
  ...
  Hindi: {
    ...
    storiesSubtitle: "सोने से पहले Eloria आपको कुछ शांत सुनाए।",
    ...
    orDescribeTheme: "या अपनी खुद की थीम बताएं",
    customThemePlaceholder: "जैसे सर्दियों में एक लाइटहाउस",
    tellIt: "बताओ",
    eloriaThinking: "Eloria एक कहानी के बारे में सोच रही है…",
